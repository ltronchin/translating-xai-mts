...
class ImageExplanation(object):
    ...
    def get_image_and_mask(self, positive_only=True, negative_only=False, hide_rest=False, num_features=5, min_weight=0.):
...
class LimeImageExplainer(object):
    ...
    def explain_instance(self,
        ...
        # Saving the arrays contained in the list in two distinct variables image_acc
        image_acc = tf.make_ndarray(tf.make_tensor_proto(image))
        image = copy.deepcopy(image_acc)  # Explanation on acceleration
